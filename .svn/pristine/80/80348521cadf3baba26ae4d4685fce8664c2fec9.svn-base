...
namespace UserModule_AUTONOMIC_MMS_IP_PROCESSOR_V3_2_6
{
    public class UserModuleClass_AUTONOMIC_MMS_IP_PROCESSOR_V3_2_6 : SplusObject
    {
...
private void ONCONNECT (  SplusExecutionContext __context__ ) 
    ...
    DOCOMMAND (  __context__ , "SetClientVersion 3.2.6") ; 
...
public UserModuleClass_AUTONOMIC_MMS_IP_PROCESSOR_V3_2_6 ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
